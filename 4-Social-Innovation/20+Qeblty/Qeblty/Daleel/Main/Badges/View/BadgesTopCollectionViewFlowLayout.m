//
//  BadgesTopCollectionViewFlowLayout.m
//  Daleel
//
...
@interface BadgesTopCollectionViewFlowLayout ()

@end

@implementation BadgesTopCollectionViewFlowLayout
...
- (NSArray<UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect {
    ...
    for (UICollectionViewLayoutAttributes *atts in attsArray) {
        ...
        CGFloat scale = 1 - (space/self.collectionView.frame.size.width/3);
        atts.transform = CGAffineTransformMakeScale(scale < 0.9 ? scale - 0.1 : scale, scale < 0.9 ? scale - 0.1:scale);
