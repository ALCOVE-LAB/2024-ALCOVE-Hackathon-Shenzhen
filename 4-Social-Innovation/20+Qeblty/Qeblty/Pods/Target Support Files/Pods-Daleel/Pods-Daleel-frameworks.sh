...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/mob_sharesdk/ShareSDK/Support/PlatformSDK/SnapChat/SCSDKLoginKit.framework"
  install_framework "${PODS_ROOT}/mob_sharesdk/ShareSDK/Support/PlatformSDK/SnapChat/SCSDKCoreKit.framework"
  install_framework "${PODS_ROOT}/mob_sharesdk/ShareSDK/Support/PlatformSDK/SnapChat/SCSDKCreativeKit.framework"
